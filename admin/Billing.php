<html lang="en">
  ...
  <?php
     ...
     $sqlselect="select Item_Number,Item_Name,Sales_Price from itemdetails";
                      ...
                      <table id="TextBoxesGroup">
                       ...
                       <tr>
                           <!--<td><input placeholder="Item Code" name="data[0][0]" class="itmcode" /></td>-->
                            ...
                            <td><select class="form-control" data-field="productid" id="productid" name="productid[]">       
                            ...
                            <td><input type="text" data-field="price" name="price[]" id="price0" placeholder="Item Amount" class="form-control name_list itmamnt" value="0.00" /></td>
   ...
   <script>
          ...
          $(document).ready(function(){
              ...
              $("#addButton").click(function(e){
                  ...
                  var regex = new RegExp("price0");
                  newRow.html(newRow.html().replace(regex, "price" + (++count) + ""));
                  //alert(newRow.html());
                  table.append(newRow);
              });
              ...
              $(document).on('change',"*[data-field='productid']",function(e)
                  {
                   
                     var price1=0.00;
                     var i=0;
                     table.find("*[data-field='productid']").each(function(){
                     var t = parseFloat($(this).val());
                     price1=!isNaN(t) ? t : 0;
                     
                     //alert("Rajesh"+count);
                     $("#price"+count).val(price1);
                     //$("#price["+count+"]").val(price1);  
